										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu" role="menu">
												...
												<li role="presentation">
													<a role="menuitem" tabindex="-1" href="category.php">- Clothing</a>
												</li>
												<li role="presentation">
													<a role="menuitem" tabindex="-1" href="category.php">- Electronics</a>
												</li>
												<li role="presentation">
													<a role="menuitem" tabindex="-1" href="category.php">- Shoes</a>
												</li>
												<li role="presentation">
													<a role="menuitem" tabindex="-1" href="category.php">- Watches</a>
												</li>
											</ul>
										</li>
									</ul>
								...
								<li>
									<div class="cart-item product-summary">
										<div class="row">
											<div class="col-xs-4">
												<div class="image">
													<a href="detail.php"><img src="assets/images/products/p4.jpg" alt="" /></a>
												</div>
											</div>
											<div class="col-xs-7">
												<h3 class="name">
													<a href="index8a95.php?page-detail">Simple Product</a>
												</h3>
							...
							<div class="nav-outer">
								<ul class="nav navbar-nav">
									...
									<li class="dropdown yamm mega-menu">
										<a href="index.php" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
									...
									<li class="dropdown mega-menu">
										<a href="category.php" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Electronics
												...
												<div class="yamm-content">
													<div class="row">
														...
														<div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
															<a href="#"><img alt="" src="assets/images/banners/top-menu-banner1.jpg" /></a>
														</div>
													</div>
													<!-- /.row -->
												</div>
									...
									<li class="dropdown hidden-sm">
										<a href="category.php">Health & Beauty
									...
									<li class="dropdown"><a href="contact.php">Shoes</a></li>
									<li class="dropdown">
													...
													<div class="row">
														<div class="col-xs-12 col-menu">
															<ul class="links">
																...
																<li>
																	<a href="shopping-cart.php">Shopping Cart Summary</a>
																</li>
																<li><a href="checkout.php">Checkout</a></li>
																<li><a href="blog.php">Blog</a></li>
																<li>
																	<a href="blog-details.php">Blog Detail</a>
																</li>
																...
																<li>
																	<a href="product-comparison.php">Product-Comparison</a>
																</li>
								...
								<div class="item">
									<div class="products">
										...
										<div class="product-info text-left m-t-20">
											<h3 class="name">
												<a href="detail.php">Floral Print Buttoned</a>
											</h3>
										...
										<div class="products">
											<div class="product">
												<div class="product-image">
													<div class="image">
														<a href="detail.php"><img src="assets/images/products/p1.jpg" alt="" /></a>
													</div>
													<!-- /.image -->
									...
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
													<div class="image">
														<a href="detail.php"><img src="assets/images/products/p2.jpg" alt="" /></a>
													</div>
													<!-- /.image -->
									...
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
													<div class="image">
														<a href="detail.php"><img src="assets/images/products/p3.jpg" alt="" /></a>
													</div>
													<!-- /.image -->
									...
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
													<div class="image">
														<a href="detail.php"><img src="assets/images/blank.gif" data-echo="assets/images/products/p5.jpg" alt="" /></a>
													</div>
													<!-- /.image -->
									...
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
													<div class="image">
														<a href="detail.php"><img src="assets/images/blank.gif" data-echo="assets/images/products/p6.jpg" alt="" /></a>
													</div>
													<!-- /.image -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<div class="module-body">
							<ul class="list-unstyled">
								...
								<li class="last">
									<a href="contact-us.php" title="Suppliers">Contact Us</a>
								</li>
							</ul>
						</div>
						<!-- /.module-body -->
